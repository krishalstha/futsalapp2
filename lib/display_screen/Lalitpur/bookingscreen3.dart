...
import 'package:newfutsal/display_screen/Lalitpur/BookedScreen3.dart';
import '../Kathmandu/BookedScreen.dart';

class BookingScreen3 extends StatefulWidget {
...
class _BookingScreenState extends State<BookingScreen3> {
  ...
  void _bookCourt() async {
    ...
    try {
      ...
      CollectionReference bookings = FirebaseFirestore.instance.collection('bookingcort3');
      ...
      if (viewVenue == true) {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => BookedScreen3()));
      }
  ...
  Widget _buildHeaderSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Lalitpur Futsal', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.teal.shade800)),
        Text('Location: Lalitpur', style: TextStyle(fontSize: 16, color: Colors.grey.shade600)),
      ],
    );
  }
